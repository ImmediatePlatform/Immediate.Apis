//HintName: IA.RouteBuilder.Dummy_GetUsersQuery.g.cs
		...
		private static void MapDummy_GetUsersQueryEndpoint(IEndpointRouteBuilder app)
		{
			var endpoint = app
				.MapGet(
					"/test",
					async (
						[FromHeader] global::Dummy.GetUsersQuery.Query parameters,
...
namespace Dummy
{
	...
	/// <remarks><see cref="global::Dummy.GetUsersQuery.Query" /> registered using <c>[FromHeader]</c></remarks>
